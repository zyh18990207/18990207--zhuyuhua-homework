package com.example.zzshopping;
...
import com.example.zzshopping.fragment.TabFirstFragment;
import com.example.zzshopping.fragment.TabSecondFragment;
import com.example.zzshopping.fragment.TabThirdFragment;
import com.example.zzshopping.util.DateUtil;
import com.example.zzshopping.util.MenuUtil;
...
public class TabFragmentActivity extends AppCompatActivity {
    ...
    private void initSearchView(Menu menu) {
        ...
        // 创建搜索结果页面的组件名称对象
        ComponentName cn = new ComponentName(this, com.example.zzshopping.SearchResultActvity.class);
